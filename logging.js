...
function sendNetworkLog(
  ...
  var formid = 'e/1FAIpQLSekQr0vVszfIMKjWaq9Qm2OHEdcfvn9gsjkb9lvBjNC5aWBsw';
  var data = {
    'entry.739155298': uid,
    'entry.1270373521': time,
    'entry.535355360': eventname,
    'entry.378818738': target,
    'entry.1471029510': info,
    'entry.1731908605': state,
    'entry.748235443': log_version,
  };
  var params = [];
  for (key in data) {
    params.push(key + '=' + encodeURIComponent(data[key]));
